...
public class HistoryScript : InteractableAction
{
    ...
    private void Start()
    {
        if (GameController.GameControllerInstance.WasEventDone(GameController.GameEventsEnum.FlintHistory))
        {
    ...
    {
        GameController.GameControllerInstance.AddEvent(GameController.GameEventsEnum.FlintHistory);
